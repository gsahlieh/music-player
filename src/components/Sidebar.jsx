...
const NavLinks = ({ handleClick }) => (
  <div className='mt-10'>
    {links.map((item) => (
      <NavLink key={item.name} to={item.to} className='flex flex-row justify-start items-center py-3 px-3 my-2 text-sm font-medium text-gray-400 hover:bg-[#4D4E53] rounded-lg' onClick={() => handleClick && handleClick()}>
...
const Sidebar = () => {
  ...
  return (
    <>
      <div className='md:flex hidden flex-col w-[240px] py-10 px-4 bg-[#242529] '>
