...
const Discover = () => {
    ...
    if (isFetching) return <Loader title='Loading songs mate...'/>
    ...
    return (
        <div className='flex flex-col'>
            <div className='w-full flex flex-col justify-between items-center sm:flex-row mt-4 mb-10'>
                ...
                <select onChange={(e) => {dispatch(selectGenreListId(e.target.value))}} value={genreListId} className="bg-[#242529] cursor-pointer text-gray-300 p-3 text-sm rounded-lg outline-none sm:mt-0 mt-5">
